...
def btcbal():
    btcj = client.get_asset_balance(asset='BTC')
    btc = btcj['free']
    return btc
...
def ethbal():
    btcj = client.get_asset_balance(asset='ETH')
    btc = btcj['free']
    return btc
...
if __name__ == '__main__':
    ...
    for item in random.shuffle(items):
        ...
        for item1 in data.keys():
            if item1 == item:
                stc_win = data[item1][0][0]
                stc_slo = data[item1][0][1]
                atr_win = data[item1][0][2]
                vpt_win = data[item1][0][3]
                vpt_slo = data[item1][0][4]
                a1 = data[item1][0][5]
                a2 = data[item1][0][6]
                a3 = data[item1][0][7]
                a4 = data[item1][0][8]
